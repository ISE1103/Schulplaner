const CACHE="schulplaner-pwa-v2-10-5-daily-symptoms";
const ASSETS=["./","index.html","styles.css","app.js","supabase-config.js","manifest.webmanifest","icons/icon.svg","icons/icon-192.png","icons/icon-512.png"];
